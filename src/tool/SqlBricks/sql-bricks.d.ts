...
declare namespace SqlBricks {
  ...
  interface SelectStatement extends Statement {
    ...
    limit(val: number): SelectStatement
    offset(val: number): SelectStatement
    defineClause(...any): SelectStatement
    /**
  ...
  interface InsertStatement extends Statement {
    ...
    defineClause(...any): InsertStatement
  }
  ...
  interface UpdateStatement extends Statement {
    ...
    defineClause(...any): UpdateStatement
  }
